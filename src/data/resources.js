...
export const resources = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Why does Samrat use both the PET Resin and Polyester Putty Resin names?", a: "Both names appear on the current TDS heading for this grade, and both are genuine search terms buyers use for this resin family. We present them together so the same product is easy to find either way." },
    ],
    sections: [
