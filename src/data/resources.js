...
export const resources = [
  ...
  },
  {
    ...
    title: "Unsaturated Polyester Resin vs Epoxy Resin: Choosing a Published Resin System",
    description: "A buyer guide for distinguishing a standard UPR requirement from the separately published epoxy casting system on this site.",
    category: "Comparison Guide",
    icon: "layers",
    readingTime: "5 min read",
    publishDate: "2026-08-06",
    seo: {
      title: "Unsaturated Polyester Resin vs Epoxy Resin | Buyer Guide",
      keywords: ["Unsaturated Polyester Resin vs Epoxy Resin", "UPR vs Epoxy Resin", "Polyester Resin vs Epoxy Resin", "Resin system selection"],
      ogTitle: "Unsaturated Polyester Resin vs Epoxy Resin",
      ogDescription: "Understand the published distinction between standard UPR for general FRP work and the separate epoxy casting system before selecting a resin system.",
    },
    quickFacts: {
    ...
    relatedSlugs: ["what-is-unsaturated-polyester-resin", "types-of-unsaturated-polyester-resin", "button-grade-resin-vs-clear-casting-resin", "how-to-select-polyester-resin-for-frp-manufacturing"],
    recommendedLinks: [
