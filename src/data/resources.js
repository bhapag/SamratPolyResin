...
export const resources = [
  ...
  },
  {
    ...
    title: "What Is Polyester Putty Resin? Samrat's PET-Modified Resin Explained",
    description: "Polyester Putty Resin is Samrat's PET-modified liquid unsaturated polyester sheet grade. Understand what it is, how the dual name works and where it's used.",
    ...
    seo: {
      ...
      ogDescription: "A clear explanation of Samrat's PET-modified liquid unsaturated polyester sheet grade, marketed as Polyester Putty Resin.",
    },
    quickFacts: { "Published product": "Polyester Putty Resin", "Resin family": "PET-modified unsaturated polyester resin", "Supplied form": "Pale-yellow liquid sheet grade", "Selection reference": "Current TDS" },
    ...
    faqs: [
      { q: "What is Polyester Putty Resin on this site?", a: "It's Samrat's PET-modified unsaturated polyester resin, supplied as a pale-yellow liquid sheet grade for PET sheets, fibre sheet products, FRP sheet lamination and panel manufacturing. Full technical data is on the current TDS." },
  ...
  },
  {
    ...
    description: "Distinguish Samrat's Polyester Putty Resin liquid sheet grade from conventional thermoplastic PET chips, pellets and commodity-plastic material.",
    ...
    comparisonTable: {
      ...
      headers: ["Buyer question", "Samrat Polyester Putty Resin", "Thermoplastic PET"],
      rows: [
        ["Material form", "Pale-yellow liquid PET-modified UPR sheet grade", "Solid commodity-plastic chips or pellets"],
        ["Document to review", "Current Polyester Putty Resin TDS", "The document for the required thermoplastic grade"],
    ...
    faqs: [
      ...
      { q: "Is Polyester Putty Resin a ready-made putty or body filler?", a: "No. Samrat supplies this grade as a liquid raw resin, not as a pre-mixed putty or body filler. Finished-product properties cannot be inferred from the liquid-resin TDS." },
    ...
    sections: [
      ...
      { heading: "Thermoplastic PET is a different material form", body: ["Thermoplastic PET is commonly supplied as chips or pellets for melt processing. Samrat's Polyester Putty Resin page instead describes a liquid PET-modified unsaturated polyester sheet grade.", "Buyers should identify the required material form before comparing specifications or requesting a quotation."] },
      { heading: "Liquid raw resin is not a ready-made putty", body: ["Samrat's Polyester Putty Resin is supplied as a liquid resin. A ready-made polyester putty or body filler is a complete formulated end product.", "Sanding, adhesion, shrinkage, hardness, flexibility and repair performance cannot be assigned to the liquid resin alone from the current product data."] },
  ...
  },
  {
    ...
    recommendedLinks: [
      { href: "/products/polyester-putty-resin/", label: "View PET Resin", description: "Review the published liquid sheet-grade role and PET Resin TDS." },
  ...
  },
  {
    ...
    recommendedLinks: [
      { href: "/products/polyester-putty-resin/", label: "View PET Resin", description: "Review the PET-modified liquid sheet-grade route and current TDS." },
  ...
  },
  {
    ...
    recommendedLinks: [
      ...
      { href: "/products/polyester-putty-resin/", label: "View Polyester Putty Resin", description: "Review the separate liquid PET-modified sheet-grade role." },
    ...
    faqs: [
      ...
      { q: "Is Polyester Putty Resin supplied as ready-made putty?", a: "No. It is supplied as a liquid PET-modified UPR sheet grade, not as a pre-mixed putty or body filler. Confirm the required material form before enquiry." },
    ...
    sections: [
      ...
      { heading: "Prepare a focused enquiry", body: ["State whether the requirement is a cultured-marble or artificial-stone component, a sheet or panel, the liquid Polyester Putty Resin grade, a ready-made putty, thermoplastic PET or another product. Then include the applicable product document, required data, quantity, packaging need, delivery location and documentation request."] },
    ],
  },
  {
