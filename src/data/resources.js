...
export function getReadingTime(resource) {
  ...
  (resource.sections || []).forEach((s) => {
    ...
    (s.definitions || []).forEach((d) => { count(d.term); count(d.also); count(d.body); });
  });
...
export const resources = [
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Conclusion",
        body: [
          "GP polyester resin remains one of the most practical and widely used resin systems in FRP manufacturing because it offers a dependable balance of mechanical performance, processability and cost. It is not designed to outperform speciality resin systems in any single demanding property, but for the broad range of general industrial applications — from water tanks and roofing sheets to industrial mouldings and construction products — it continues to provide manufacturers with a reliable, economical and well-understood material. Selecting the right grade, and following correct storage and handling practices, remains essential to achieving consistent results in production. Each of <a href='/products/gp-resins/'>the GP resin grades we manufacture</a> publishes its own viscosity, gel time and curing system, which is where that selection decision is actually made.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "The table below summarises how viscosity and gel time needs typically shift across common FRP processes. Treat it as a starting point for narrowing down candidate grades, not as a substitute for checking the specific product's technical data sheet. To take the next step, <a href='/products/gp-resins/'>compare the GP grades side by side</a> — that page tabulates each grade's published viscosity, gel time, styrene content and curing system from its own TDS.",
        ],
        table: "processTable",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Information to provide before selection", body: ["Share the component, whether reinforcement is involved, intended appearance or product role, process, expected quantity and delivery location. If an epoxy system is stated in the requirement, include that source document or wording for review. It is also worth checking <a href='/products/epoxy-resins/'>the epoxy grades we actually stock</a> before specifying, since the comparison above is about resin chemistry in general rather than a particular product."] },
    ],
  },
  {
    ...
    relatedSlugs: ["unsaturated-polyester-resin-vs-epoxy-resin", "casting-resin-vs-coating-resin", "epoxy-clear-casting-resin-buyer-guide"],
    recommendedLinks: [
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-epoxy-clear-casting-resin", "what-is-epoxy-art-resin", "applications-of-epoxy-art-resin", "epoxy-art-resin-buyer-guide", "unsaturated-polyester-resin-vs-epoxy-resin", "epoxy-clear-casting-resin-buyer-guide"],
    recommendedLinks: [
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-epoxy-clear-casting-resin", "casting-resin-vs-coating-resin", "unsaturated-polyester-resin-vs-epoxy-resin"],
    recommendedLinks: [
  ...
  },
  {
    ...
    quickFacts: { "Published product": "PET Resin / Polyester Putty Resin", "Resin family": "PET-modified unsaturated polyester resin", "Supplied form": "Pale-yellow liquid sheet grade", "Selection reference": "Current TDS" },
    ...
    recommendedLinks: [
      { href: "/products/pet-resin/", label: "View PET Resin / Polyester Putty Resin", description: "Review the product role, specifications, pack and enquiry path." },
      ...
      { href: "/contact/", label: "Discuss a PET Resin / Polyester Putty Resin requirement", description: "Share the exact liquid form and intended sheet or laminate application." },
    ],
    faqs: [
      { q: "What is PET Resin / Polyester Putty Resin on this site?", a: "It's Samrat's PET-modified unsaturated polyester resin, supplied as a pale-yellow liquid sheet grade for PET sheets, fibre sheet products, FRP sheet lamination and panel manufacturing. Full technical data is on the current TDS." },
      { q: "Is this PET Resin a conventional thermoplastic PET material?", a: "No. It's a liquid, styrene-compatible unsaturated polyester resin system with polyethylene terephthalate content — not solid thermoplastic PET chips, pellets or a bottle-grade material." },
      { q: "Why does Samrat use both the PET Resin and Polyester Putty Resin names?", a: "Both names appear together on the current TDS heading and form the approved buyer-facing identity for the same Samrat grade." },
    ],
    sections: [
      { heading: "The PET Resin / Polyester Putty Resin identity", body: ["Samrat Poly Resins manufactures PET Resin / Polyester Putty Resin as a PET-modified unsaturated polyester resin, supplied as a pale-yellow liquid sheet grade. The current TDS describes polyethylene terephthalate content in a liquid, styrene-compatible resin system and is the controlling technical reference for this product.", "It sits within the broader unsaturated polyester resin family while retaining its own grade and application context — start with your exact finished sheet or laminate requirement and the current TDS."] },
      ...
      { heading: "Published application context", body: ["The current TDS lists PET sheets and fibre sheet products, together with FRP sheet lamination and panel manufacturing. These are the application contexts used in this guide.", "Finished-product performance depends on the complete sheet, laminate or panel system and is not established by the liquid-resin name alone."] },
      { heading: "Use the product document to start a focused enquiry", body: ["Share the intended PET-sheet, fibre-sheet, FRP-sheet or panel application; required liquid-resin form; relevant technical data; quantity; packaging need; delivery location; and requested documentation."] },
    ],
  },
  {
    ...
    quickFacts: { "Samrat product form": "Liquid PET-modified unsaturated polyester sheet grade", "Different PET form": "Thermoplastic chips or pellets", "Also not supplied": "Ready-made putty or filler compound", "Buyer action": "State the required material form" },
    comparisonTable: {
      title: "Keep the material forms separate",
      headers: ["Buyer question", "Samrat PET Resin / Polyester Putty Resin", "Thermoplastic PET"],
      rows: [
        ["Material form", "Pale-yellow liquid PET-modified UPR sheet grade", "Solid commodity-plastic chips or pellets"],
        ["Document to review", "Current PET Resin / Polyester Putty Resin TDS", "The document for the required thermoplastic grade"],
        ["Samrat grade context", "PET sheets, fibre sheets, FRP sheet lamination and panels", "Not the product route described by the liquid-resin TDS"],
      ],
    ...
    recommendedLinks: [
      { href: "/products/pet-resin/", label: "View PET Resin / Polyester Putty Resin", description: "Open the product page for the approved liquid sheet-grade route." },
    ...
    faqs: [
      ...
      { q: "Is PET Resin / Polyester Putty Resin a ready-made putty or body filler?", a: "No. Samrat supplies this grade as a liquid raw resin, not as a pre-mixed putty or body filler. Finished-product properties cannot be inferred from the liquid-resin TDS." },
    ...
    sections: [
      ...
      { heading: "Thermoplastic PET is a different material form", body: ["Thermoplastic PET is commonly supplied as chips or pellets for melt processing. Samrat's PET Resin / Polyester Putty Resin page instead describes a liquid PET-modified unsaturated polyester sheet grade.", "Buyers should identify the required material form before comparing specifications or requesting a quotation."] },
      { heading: "Liquid raw resin is not a ready-made putty", body: ["Samrat's PET Resin / Polyester Putty Resin is supplied as a liquid resin. A ready-made polyester putty or body filler is a complete formulated end product.", "Sanding, adhesion, shrinkage, hardness, flexibility and repair performance cannot be assigned to the liquid resin alone from the current product data."] },
      { heading: "A clearer purchase brief", body: ["State the required material form first. For Samrat's liquid grade, provide the finished sheet, laminate or panel application, quantity, packaging need, delivery location and requested documentation. If the requirement is thermoplastic PET or a ready-made putty, say so at the outset so the enquiry is not routed to the wrong product."] },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-pet-modified-polyester-resin", "pet-resin-applications-sheet-lamination-and-panels", "pet-resin-vs-lamination-resin"],
    recommendedLinks: [
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-pet-modified-polyester-resin", "pet-resin-vs-gp-resin", "pet-resin-applications-sheet-lamination-and-panels"],
    recommendedLinks: [
  ...
  },
  {
    ...
    relatedSlugs: ["bisphenol-resin-applications", "bisphenol-resin-vs-upr-and-gp-resin", "bisphenol-resin-vs-epoxy-resin", "bisphenol-resin-data-vs-finished-component-performance", "bisphenol-resin-procurement-checklist"],
    recommendedLinks: [
    ...
    faqs: [
      ...
      { q: "Is Bisphenol-A terminology supported?", a: "Yes. The current product-specific TDS uses the exact wording 'Bisphenol A & epichlorohydrin based (thermosetting)'." },
      { q: "Is this product an Unsaturated Polyester Resin or Vinyl Ester Resin?", a: "The current product-specific TDS does not identify it as either and lists styrene content as not applicable. Vinyl Ester Resin and UPR remain separate Samrat product routes with their own TDS documents." },
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-bisphenol-resin", "bisphenol-resin-data-vs-finished-component-performance", "bisphenol-resin-procurement-checklist"],
    recommendedLinks: [
      ...
      { href: "/resources/bisphenol-resin-procurement-checklist/", label: "Prepare a Bisphenol Resin RFQ", description: "Share the exact application, technical requirement and commercial details." },
    ],
    faqs: [
    ...
    sections: [
      { heading: "Laminating and FRP composites", body: ["The current TDS lists laminating and FRP composites. In that context, Bisphenol Resin is the resin or matrix product and Glass Fiber is a separate reinforcement product. This establishes a material-role discussion, not a prescribed laminate design.", "A buyer should identify the finished composite component, any stated technical requirement, expected quantity and required documentation. The TDS does not publish glass type, mat weight, reinforcement ratio, thickness or cure schedule."] },
  ...
  },
  {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        ["What to verify", "Current Bisphenol Resin TDS, application and stated requirement", "Required GP or UPR product role, process and stated technical requirement"],
      ],
    },
    ...
    faqs: [
      ...
      { q: "Which route should a general FRP buyer start with?", a: "For a broad general-purpose FRP requirement, review UPR and GP Clear documentation. Review Bisphenol Resin where its current TDS-listed product context and technical data match the requirement." },
  ...
  },
  {
    ...
    relatedSlugs: ["what-is-bisphenol-resin", "bisphenol-resin-data-vs-finished-component-performance", "bisphenol-resin-procurement-checklist"],
    recommendedLinks: [
      { href: "/products/bisphenol-resin/", label: "View Bisphenol Resin", description: "Review the current product-specific TDS wording, application context and quote path." },
    ...
    faqs: [
      ...
      { q: "Does the shared word 'Bisphenol' make this product interchangeable with every epoxy or Vinyl Ester Resin?", a: "No. The current Bisphenol Resin TDS and each separate product route must be reviewed for the stated application. A shared chemistry word does not establish interchangeability." },
    ],
    sections: [
  ...
  },
  {
    ...
    recommendedLinks: [
      ...
      { href: "/resources/bisphenol-resin-procurement-checklist/", label: "Prepare a Bisphenol Resin RFQ", description: "Turn the current product data and application requirement into a focused enquiry." },
    ],
    faqs: [
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ["Bisphenol Resin Procurement", "Bisphenol Resin RFQ", "Bisphenol Resin Buying Checklist", "Bisphenol Resin Technical Documents"],
    ...
    relatedSlugs: ["what-is-bisphenol-resin", "bisphenol-resin-applications", "bisphenol-resin-data-vs-finished-component-performance"],
    recommendedLinks: [
  ...
  },
  {
    ...
    recommendedLinks: [
      ...
      { href: "/products/pet-resin/", label: "View PET Resin / Polyester Putty Resin", description: "Review the separate liquid PET-modified sheet-grade role." },
      { href: "/resources/pet-resin-liquid-grade-vs-thermoplastic-pet/", label: "Clarify PET Resin material form", description: "Keep the liquid Samrat grade separate from thermoplastic PET and ready-made putty." },
    ],
    faqs: [
      ...
      { q: "Is PET Resin / Polyester Putty Resin supplied as ready-made putty?", a: "No. It is supplied as a liquid PET-modified UPR sheet grade, not as a pre-mixed putty or body filler. Confirm the required material form before enquiry." },
    ...
    sections: [
      ...
      { heading: "Keep product and material form clear", body: ["PET Resin and Polyester Putty Resin are the approved names for Samrat's liquid PET-modified sheet grade. That liquid raw resin is different from a ready-made putty or thermoplastic PET chips.", "Marble Resin has its own supplied-resin role for cultured-marble and artificial-stone contexts. Confirm the required material form and finished component before product selection."] },
      ...
      { heading: "Prepare a focused enquiry", body: ["State whether the requirement is a cultured-marble or artificial-stone component, a sheet or panel, the liquid PET Resin / Polyester Putty Resin grade, a ready-made putty, thermoplastic PET or another product. Then include the applicable product document, required data, quantity, packaging need, delivery location and documentation request."] },
    ],
  },
  {
