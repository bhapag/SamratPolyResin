...
export const applications = [
  ...
  // ============================================================================
  //  VINYL ESTER RESIN APPLICATIONS — buyer-selection pages based on the
  //  current Vinyl Ester TDS. They retain only the documented application and
  //  process categories, link buyers to product data, and keep the complete
  //  FRP system separate from the supplied liquid resin. They intentionally do
  //  not prescribe construction, catalyst use, chemical compatibility or
  //  finished-component performance. Cooling towers, marine/boat hulls,
  //  pressure vessels and offshore structures are not standalone pages because
  //  the current source material does not justify distinct buyer guidance.
  // ============================================================================
  {
    ...
    seo: {
      title: "Vinyl Ester Resin for FRP Chemical Storage Tanks",
      description: "Buyer guidance for selecting Samrat Poly Resins Vinyl Ester Resin for documented FRP chemical storage tank and vessel applications.",
      keywords: ["Vinyl Ester Resin for FRP Chemical Tanks", "FRP Chemical Storage Tank Resin", "Chemical Storage Vessel Resin"],
    },
    draft: false,
    intro: "Samrat Poly Resins lists Vinyl Ester Resin for FRP tanks and chemical storage vessels. This page supports material selection and procurement; it does not certify a finished tank for a particular chemical duty.",
    whatTheyManufacture: "FRP chemical storage tanks and vessels are finished industrial components. Before selecting a resin, buyers should define the stored medium, concentration where relevant, temperature, exposure conditions and project specification.",
    whySuitable: 'The Vinyl Ester Resin TDS identifies FRP tanks and chemical storage vessels as applications and gives the grade broad water, acid, alkali and solvent-resistance positioning. It does not provide a chemical-by-chemical compatibility chart or a finished-tank approval. Review the <a href="/products/vinyl-ester-resin/">Vinyl Ester Resin product data</a> and share the actual service requirement before grade selection.',
    requiredCharacteristics: [
      "The actual service medium and concentration where relevant",
      "Operating temperature and exposure conditions where relevant",
      "The finished tank or vessel specification and any required testing",
      "Reinforcement, construction and surface-system requirements for the finished component",
      "The product TDS and required procurement documentation",
    ],
    manufacturingProcess: 'This is a product-selection page, not a tank-design or fabrication manual. Vinyl Ester Resin is the matrix component; <a href="/products/fibre-glass-mat/">Glass Fiber</a>, laminate construction, thickness, surface system, cure state and the tested configuration are separate parts of a finished FRP tank system.',
    advantages: [
      "Uses the exact TDS-listed tank and vessel application context",
      "Keeps liquid-resin data separate from finished-tank performance",
      "Prompts buyers to verify their actual service and documentation requirement",
      "Links to the published TDS before an RFQ is raised",
    ],
    commonProducts: [
      "FRP chemical storage tanks",
      "FRP chemical storage vessels",
    ],
    faqs: [
      {
        q: "Is Vinyl Ester Resin automatically the right resin for every storage tank?",
        a: 'No. The TDS lists tank and vessel use, but the appropriate grade and finished system depend on the project requirement. For general FRP work, review <a href="/products/gp-clear-resin/">GP Clear Resin</a>; for a chemical-service requirement, share the service details before selecting a grade.',
      },
      {
        q: "Does the resin TDS certify the finished FRP tank?",
        a: "No. The TDS describes the supplied resin. Finished-tank performance depends on the complete FRP system, including reinforcement, construction, surface system, cure state and the relevant tested configuration.",
      },
      {
        q: "Can Vinyl Ester Resin be selected for any chemical concentration?",
        a: "No universal compatibility claim is published. Provide the service medium, concentration where relevant, operating temperature, exposure context and required specification so the requirement can be reviewed against the available product documentation.",
      },
      {
        q: "What reinforcement should be used in a Vinyl Ester tank?",
        a: 'Vinyl Ester Resin is the matrix component and <a href="/products/fibre-glass-mat/">Glass Fiber</a> is reinforcement. The TDS does not prescribe a universal reinforcement type or tank construction, so that requirement must be established for the finished system.',
      },
      {
        q: "What should I include in a tank-resin RFQ?",
        a: "Share the finished component, service medium, concentration and operating temperature where relevant, required specification or testing, documentation requirement, quantity and delivery location. Do not rely on a product name alone for a finished chemical-service system.",
      },
    ],
    ...
    recommendedLinks: [
      { href: "/resources/vinyl-ester-resin-for-chemical-service-frp/", label: "Chemical-service buyer guide", description: "Information to share when the project has a chemical-service requirement." },
      { href: "/resources/vinyl-ester-resin-technical-specifications/", label: "Vinyl Ester technical specifications", description: "Read the published liquid-resin data in context." },
      { href: "/tds/vinyl-ester-resin-tds.pdf", label: "Vinyl Ester Resin TDS", description: "Open Samrat Poly Resins' product data sheet." },
    ],
    ctaHeading: "Need Vinyl Ester Resin for an FRP tank or vessel?",
    ctaText: "Request a quote with the finished component, service requirement, required documentation, quantity and delivery location so the appropriate product route can be discussed.",
  },
  {
    ...
    seo: {
      title: "Vinyl Ester Resin for FRP Pipelines, Ducts & Scrubbers",
      description: "Buyer guidance for the documented use of Samrat Poly Resins Vinyl Ester Resin in FRP pipelines, ducts and scrubbers.",
      keywords: ["Vinyl Ester Resin for FRP Pipelines", "Vinyl Ester Resin for FRP Ducts", "Vinyl Ester Resin for Scrubbers"],
    },
    draft: false,
    intro: "Samrat Poly Resins lists Vinyl Ester Resin for pipelines, ducts and scrubbers. This is selection guidance for buyers who must match a resin product and a finished FRP system to an actual industrial service requirement.",
    whatTheyManufacture: "FRP pipelines, ducts and scrubbers are finished components that may carry or handle a process stream. The product name alone cannot establish compatibility with a particular gas, fume or liquid.",
    whySuitable: 'The Vinyl Ester Resin TDS lists pipelines, ducts and scrubbers and provides broad water, acid, alkali and solvent-resistance positioning. It does not publish a chemical-specific compatibility chart, a continuous-service temperature, or a finished-component classification. Review the <a href="/products/vinyl-ester-resin/">Vinyl Ester Resin product data</a> and provide the real service conditions before selecting a grade.',
    requiredCharacteristics: [
      "The service medium, concentration and exposure context where relevant",
      "Operating temperature and required service conditions",
      "The finished component specification and any required verification or testing",
      "Reinforcement, construction and surface-system requirements for the finished component",
      "Published TDS data and the required procurement documentation",
    ],
    manufacturingProcess: 'This page does not prescribe a fabrication process, catalyst system, lining construction or joint design. Vinyl Ester Resin is the matrix component; <a href="/products/fibre-glass-mat/">Glass Fiber</a>, the laminate, surface system, cure state and tested configuration remain separate finished-system decisions.',
    advantages: [
      "Uses only TDS-listed pipeline, duct and scrubber application categories",
      "Keeps broad product positioning separate from chemical-specific compatibility",
      "Keeps liquid-resin information separate from the performance of the finished component",
      "Helps buyers submit a technically useful enquiry",
    ],
    commonProducts: [
      "FRP pipelines",
      "FRP ducts",
    ...
    faqs: [
      {
        q: "Are Vinyl Ester Resin pipelines, ducts and scrubbers a documented application?",
        a: "Yes. The Vinyl Ester Resin TDS lists pipelines, ducts and scrubbers. The appropriate grade and finished system still need to be matched to the actual service requirement.",
      },
      {
      ...
      },
      {
        ...
        a: "No. Finished performance depends on the complete system, including reinforcement, laminate construction, thickness, surface system, cure state and the relevant tested configuration.",
      },
      {
    ...
    recommendedLinks: [
      { href: "/resources/vinyl-ester-resin-for-chemical-service-frp/", label: "Chemical-service buyer guide", description: "Information to share for a chemical-service review." },
      { href: "/resources/vinyl-ester-resin-technical-specifications/", label: "Vinyl Ester technical specifications", description: "Read the published liquid-resin data in context." },
      { href: "/tds/vinyl-ester-resin-tds.pdf", label: "Vinyl Ester Resin TDS", description: "Open Samrat Poly Resins' product data sheet." },
    ],
    ctaHeading: "Need Vinyl Ester Resin for an FRP pipeline, duct or scrubber?",
    ctaText: "Request a quote with the finished component, service requirement, documentation need, quantity and delivery location so the correct product route can be discussed.",
  },
  {
    ...
    seo: {
      title: "Vinyl Ester Resin for Filament Winding",
      description: "Buyer guidance for selecting Samrat Poly Resins Vinyl Ester Resin where a filament-winding process is specified for an FRP component.",
      keywords: ["Vinyl Ester Resin Filament Winding", "Filament Winding Resin", "Vinyl Ester Resin for FRP"],
    },
    draft: false,
    intro: "The Vinyl Ester Resin TDS lists filament winding as a process application. This page helps a buyer verify the published resin data and define the separate process and finished-component requirements; it is not a winding instruction.",
    whatTheyManufacture: "Filament winding is a composite manufacturing process. The TDS also lists FRP tanks, chemical storage vessels and pipelines as product-application contexts, but final component design and performance remain separate from the supplied resin data.",
    whySuitable: 'The published Vinyl Ester Resin data identifies filament winding and shows a typical viscosity of 350 cPs at 25°C. That figure is liquid-resin product data, not a universal confirmation for a particular line, fibre, part geometry, cycle or finished-component specification. Review the <a href="/products/vinyl-ester-resin/">product TDS</a> against the actual process requirement before purchase.',
    requiredCharacteristics: [
      "The documented liquid-resin viscosity and relevant product data",
      "The actual process, reinforcement and finished-component requirement",
      "Any service medium, concentration, operating temperature and project specification",
      "Finished-system verification or testing requirements",
      "The required documentation, quantity, packaging and delivery route",
    ],
    manufacturingProcess: 'No winding angles, cure schedules, catalyst levels, resin-to-glass ratios or component designs are prescribed here. Vinyl Ester Resin is the matrix component and <a href="/products/fibre-glass-mat/">Glass Fiber</a> is reinforcement; their suitability must be confirmed for the actual finished FRP system.',
    advantages: [
      "Uses a process category explicitly listed in the Vinyl Ester Resin TDS",
      "Makes the published typical viscosity easy to verify",
      "Keeps liquid-resin data distinct from process and finished-component performance",
      "Prompts buyers to communicate the information needed for a useful RFQ",
    ],
    commonProducts: [
      "FRP components where filament winding is specified",
      "TDS-listed FRP tanks, chemical storage vessels and pipelines where the project specifies filament winding",
    ],
    faqs: [
      {
        q: "Is filament winding a documented Vinyl Ester Resin process route?",
        a: "Yes. It is listed in the product TDS. The TDS does not establish that the resin is suitable for every winding line, component design or finished-system requirement.",
      },
      {
        q: "What does the published 350 cPs figure mean?",
        a: "It is a typical liquid-resin viscosity at 25°C in the TDS. Buyers should review it with the required process and product specification rather than treating it as a universal process setting.",
      },
      {
        q: "Does the resin alone determine a filament-wound component's performance?",
        a: 'No. The finished FRP system also involves reinforcement, construction, thickness, surface system, cure state and the relevant tested configuration. See <a href="/resources/what-is-vinyl-ester-resin/">what Vinyl Ester Resin is and what its product data does not establish</a>.',
      },
      {
        q: "Can this page provide winding angles, cure settings or catalyst ratios?",
        a: "No. Those are operational fabrication decisions outside this buyer-selection guide. Request and review the applicable technical documentation for the actual manufacturing system.",
      },
      {
    ...
    recommendedLinks: [
      { href: "/resources/vinyl-ester-resin-technical-specifications/", label: "Vinyl Ester technical specifications", description: "Read the published typical liquid-resin data in context." },
      { href: "/resources/what-is-vinyl-ester-resin/", label: "Resin data vs finished FRP", description: "Understand why a resin TDS is not a component-performance guarantee." },
      { href: "/tds/vinyl-ester-resin-tds.pdf", label: "Vinyl Ester Resin TDS", description: "Open Samrat Poly Resins' product data sheet." },
    ],
    ctaHeading: "Need Vinyl Ester Resin for a specified filament-winding process?",
    ctaText: "Request a quote with the component, process requirement, technical-document need, quantity and delivery location.",
  },
  {
    ...
    seo: {
      title: "Vinyl Ester Resin for Pultrusion",
      description: "Buyer guidance for selecting Samrat Poly Resins Vinyl Ester Resin where a pultrusion process is specified for an FRP component.",
      keywords: ["Vinyl Ester Resin Pultrusion", "Pultrusion Resin", "Vinyl Ester Resin for FRP"],
    },
    draft: false,
    intro: "The Vinyl Ester Resin TDS lists pultrusion as a process application. This page supports buyer-level product selection and technical-document review; it does not prescribe a pultrusion process or finished-profile design.",
    whatTheyManufacture: "Pultrusion is a composite manufacturing process for continuous FRP profiles. The specific component, reinforcement, process settings and any service condition must be defined separately from the supplied resin.",
    whySuitable: 'Pultrusion is explicitly listed in the Vinyl Ester Resin TDS. The document provides product-level liquid-resin data, but it does not publish pultrusion line settings, profile types, finished-profile properties or a chemical-specific service recommendation. Review the <a href="/products/vinyl-ester-resin/">Vinyl Ester Resin product data</a> against the actual requirement before selection.',
    requiredCharacteristics: [
      "The documented product data and the specified pultrusion requirement",
      "The actual FRP component and reinforcement requirement",
      "Any service medium, concentration, temperature and project specification",
      "Finished-system performance or test requirements",
      "Required technical documentation, quantity, packaging and delivery location",
    ],
    manufacturingProcess: 'This page intentionally does not provide line speed, die temperature, catalyst level, cure schedule, resin-to-glass ratio or profile-design advice. Vinyl Ester Resin is the matrix component; <a href="/products/fibre-glass-mat/">Glass Fiber</a>, profile construction, cure state and finished-system verification are separate decisions.',
    advantages: [
      "Uses a process category explicitly listed in the Vinyl Ester Resin TDS",
      "Keeps product data separate from a particular pultrusion-line validation",
      "Keeps broad chemical-service positioning separate from chemical-specific compatibility",
      "Helps a buyer submit the details needed for a useful enquiry",
    ],
    commonProducts: [
      "FRP components where a pultrusion process is specified",
    ],
    faqs: [
      {
        q: "Is pultrusion a documented Vinyl Ester Resin process route?",
        a: "Yes. It is listed in the product TDS. The published resin data does not establish suitability for every pultrusion line, profile type or finished-system requirement.",
      },
      {
        q: "Can this page provide pultrusion settings or catalyst ratios?",
        a: "No. Operational manufacturing directions are outside this buyer-selection guide. Review the relevant technical documentation for the actual process requirement.",
      },
      {
        q: "Does Vinyl Ester Resin alone determine finished-profile performance?",
        a: "No. A finished FRP profile can depend on reinforcement, construction, thickness, surface system, cure state and the relevant tested configuration.",
      },
      {
        q: "Can this page confirm chemical compatibility for a particular installation?",
        a: "No. The product documentation does not include a chemical-by-chemical compatibility chart. Share the actual medium, concentration, operating temperature, exposure context and project requirement for a product-data review.",
      },
      {
    ...
    recommendedLinks: [
      { href: "/resources/vinyl-ester-resin-technical-specifications/", label: "Vinyl Ester technical specifications", description: "Read the published liquid-resin data in context." },
      { href: "/resources/what-is-vinyl-ester-resin/", label: "What is Vinyl Ester Resin?", description: "Understand the documented product role and finished-system boundary." },
      { href: "/tds/vinyl-ester-resin-tds.pdf", label: "Vinyl Ester Resin TDS", description: "Open Samrat Poly Resins' product data sheet." },
    ],
    ctaHeading: "Need Vinyl Ester Resin for a specified pultrusion process?",
    ctaText: "Request a quote with the component, process requirement, technical-document need, quantity and delivery location.",
  },
  {
    ...
    recommendedLinks: [
      { href: "/resources/what-is-roof-light-sheet-grade-resin/", label: "Review Roof Light Resin applications", description: "Use the published roof-light, skylight and roofing-sheet contexts before selection." },
      { href: "/resources/what-is-roof-light-sheet-grade-resin/", label: "Compare Roof Light and Sheet Grade Yellow", description: "Separate water-white roof-light intent from the pre-pigmented yellow sheet/panel route." },
