...
export const products = [
  ...
  },
  {
    ...
    specs: {
      "Minimum Order Quantity": "1000 kg",
      "Usage / Application": "Hand Layup, Spray Up, Lamination, Moulding, Roofing Sheet, Panel, Water Tank, Cooling Tower, Door Skin, General Purpose",
    ...
    tagline: "Crystal-clear, high-gloss general-purpose resin.",
    description:
      "A crystal-clear, high-gloss general-purpose unsaturated polyester resin formulated for versatile FRP manufacturing. Orthophthalic-based with excellent wet-out for superior flow and impregnation, it delivers high mechanical strength, good chemical resistance and reliable, consistent performance batch after batch, with a fast sub-8-minute gel time and a non-accelerated cure.",
    features: [
      "Crystal-clear finish with excellent transparency and high gloss",
      "Excellent wet-out for superior flow and impregnation",
      "High mechanical strength and good chemical resistance",
      "Easy to process — easy mixing with low air entrapment",
      "Fast gel time (<8 min), non-accelerated cure",
      "Supplied in 225 kg drums, minimum order 1000 kg",
    ],
    applications: [
      "Water tanks, roofing sheets and door skins",
      "Hand layup, spray-up, panels and lamination work",
      "Moulding, cooling towers and general-purpose FRP products",
    ],
  },
  {
    slug: "gp-white-resin",
