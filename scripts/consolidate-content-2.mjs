...
//    CONTENT_CONSOLIDATION_MAP_2.md   the audit record
//
...
import { RETIRE, GUIDES, GSC, REASONS, KEPT } from './consolidation-2-plan.mjs';

const root = join(dirname(fileURLToPath(import.meta.url)), '..');
const RESOURCES = join(root, 'src/data/resources.js');
const REDIRECTS = join(root, 'public/_redirects');
const MAP = join(root, 'CONTENT_CONSOLIDATION_MAP_2.md');
...
const block = [
  '',
  '# Content consolidation pass 2 (2026-09-09)',
  ...
  '# See CONTENT_CONSOLIDATION_MAP_2.md for the full record.',
];
...
writeFileSync(MAP, `# CONTENT_CONSOLIDATION_MAP_2.md
